-- Repair: idempotent re-apply of follows / gifts / send_gift (for DBs that never ran
-- 20260429203742 or have a stale PostgREST schema cache). After DDL, grant RPC to
-- service_role and reload API schema.

-- =====================================================================
-- Follows + Gifts system (idempotent)
-- =====================================================================
...
GRANT EXECUTE ON FUNCTION public.send_gift(uuid, uuid, integer, text) TO service_role;
GRANT EXECUTE ON FUNCTION public.send_gift(uuid, uuid, integer, text) TO postgres;
...
-- Tell PostgREST to reload schema cache (fixes "Could not find ... in the schema cache")
