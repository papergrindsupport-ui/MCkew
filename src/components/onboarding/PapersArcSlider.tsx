...
import { FileText, Flame, Zap, Trophy, Rocket } from "lucide-react";

interface PapersArcSliderProps {
  value: number;
...
const STOPS = [
  { val: 1, label: "1", sublabel: "Casual", Icon: FileText },
  { val: 2, label: "2", sublabel: "Steady", Icon: Flame },
  { val: 3, label: "3", sublabel: "Focused", Icon: Zap },
  { val: 5, label: "5", sublabel: "Intense", Icon: Trophy },
  { val: 8, label: "8", sublabel: "Beast", Icon: Rocket },
];
...
export default function PapersArcSlider({ value, onChange, isBoring }: PapersArcSliderProps) {
