...
export const QUESTIONS: Question[] = [
  // ───────────────────── Q1: bio-2024-June-V2 ─────────────────────
  {
    ...
    topics: ["plants", "cells"],
    lessons: ["photosynthesis", "membrane"],
  ...
  // ───────────────────── Q6: phys-2024-June-V2 ─────────────────────
  {
    ...
    topics: ["waves"],
    lessons: ["diffraction", "interference"],
  ...
  // ───── MCQ 5: image-options 2x2 GRID — bio
  {
    ...
    topics: ["body-systems", "cells"],
    lessons: ["transport-animals"],
